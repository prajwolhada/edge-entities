...
@Setter
@Entity
@Table(name = "GCM_ALERT_TRANSACTIONS")
public class GcmAlertTransaction implements Serializable {
    ...
    @Column(name = "GCM_MESSAGE_ID", length = 200)
    private String gcmMessageId;

    public GcmAlertTransaction() {
    }
}